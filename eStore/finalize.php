						...
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-6 mb-5">
								...
								<form class="form-horizontal" id="changeClientContactForm" action="php_action/ctrl_client.php.php?action=editContact" method="POST" enctype="multipart/form-data">
									<div class="form-group mt-4">
										...
										<div class="">
											<input type="text" class="form-control col-6"  id="contact" placeholder="<?php echo $language['contact'] ?>" name="name" autocomplete="off" required>
										</div>
									</div>
							...
							<div class="discount-options col-sm-12 col-md-6 col-lg-6">
								...
								<div class="discount" id="panel2">
									...
									<form class="form-horizontal" id="setDescountForm" action="php_action/ctrl_cart.php.php?action=setDescount" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="payWithMpesa box">
						...
						<form class="form-horizontal mx-0 px-0" id="submitCardInformationForm" action="php_action/ctrl_cart.php?action=finalizePayment" method="POST" enctype="multipart/form-data">
							...
							<hr>
							<p class="small text-center"><i class="fas fa-info-circle"></i> Confirme via MPESA no seu numero <span id="client_payment_contact" class="font-weight-bolder"></span></p>
