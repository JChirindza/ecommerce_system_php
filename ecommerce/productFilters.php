...
<div class="d-flex" id="wrapper">
	<div class="container-fluid bg-white m-4">
		<div class="row">
			<div class="col-sm-12 col-md-2 col-lg-2 border-right p-4">                				
				...
				<div class="list-group mt-4 border-top">
					...
					<div class="text-muted">
						<label>Computadores</label><br>
						<label>Hardware e pesas de Rede</label><br>
						<label>Componentes de Computadores</label>
					</div>
				</div>		
				<div class="list-group mt-4 border-top">
