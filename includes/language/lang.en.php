...
$language['do-you-r-w-to-exit'] = 'Do you really want exit';
$language['if-y-w-end-session'] = 'if you want to end the session';
$language['do-y-r-w-change-this-user'] = 'Do you really want to change this user';
$language['select'] = 'Select';
$language['change'] = 'Change';
$language['if-y-w-end-session-and-sign-in-w-o-user'] = 'if you want to end this session and sign-in with other user';
$language['change-user'] = 'Change user';
...
$language['payment-options'] = 'Payment options';
$language['choose-one-of-the-following-opt-to-finalize'] = 'Choose one of the following options to finalize';
$language['back-to-cart'] = 'Back to cart';
...
$language['access-403'] = 'Access denied. You don\'t have permission to access this page';
...
// Brands
$language['add-brand'] = 'Add brand';
$language['manage-brands'] = 'Manage Brands';
$language['brand-name'] = 'Brand name';
$language['edit-brand'] = 'Edit brand';
$language['remove-brand'] = 'Remove brand';

// product
$language['add-product'] = 'Add product';
$language['manage-products'] = 'Manage products';
$language['product-image'] = 'Product Image';
$language['edit-product'] = 'Edit Product';
$language['remove-product'] = 'Remove product';
$language['product'] = 'Product';
$language['information'] = 'Information';
$language['product-information'] = 'Product information';
$language['available-quantity'] = 'Available quantity';
$language['add-details'] = 'Add details';
$language['add-product-details'] = 'Add product details';
$language['detail-description'] = 'Detail description';
$language['edit-product-details'] = 'Edit product details';
...
$language['partial-payment'] = 'Partial payment';
...
$language['successfully-updated'] = 'Successfully Update';
$language['error-while-update'] = 'Error while update';
$language['successfully-removed'] = 'Successfully Removed';
$language['error-while-remove'] = 'Error while remove';
$language['existing-email-please-type-another-one'] = 'Existing email, please type another one!';
$language['successfully-added'] = 'Successfully Added';
