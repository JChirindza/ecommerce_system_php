...
$language['sign-in-f-a-better-experience'] = 'Autentique-se para uma melhor experiencia';
...
$language['access-403'] = 'Acesso negado. Você não tem permissão para acessar esta página';

// Dashboard
$language['dashboard'] = 'Página Inicial';
...
$language['users-orders'] = 'Pedidos de usuários';
$language['employees'] = 'Funcionários';
$language['clients'] = 'Clientes';
$language['users-req'] = 'Solicitações de Usuários';
$language['name'] = 'Nome';
$language['surname'] = 'Apelido';
$language['type'] = 'Tipo';
$language['admin'] = 'Administrador';
$language['manager'] = 'Gestor';
$language['vendor'] = 'Vendedor';
...
// Orders
$language['add-order'] = 'Adicionar pedido';
$language['manage-orders'] = 'Gerir pedidos';
$language['order-date'] = 'Data do pedido';
$language['client-name'] = 'Nome do cliente';
$language['edit-order'] = 'Alterar pedido';
$language['remove-order'] = 'Remover pedido';
$language['total-order-items'] = 'Total de itens pedidos';
$language['payment-place'] = 'Local de pagamento';
$language['edit'] = 'Alterar';
...
$language['province'] = 'Provincia';
$language['address'] = 'Endereço';
$language['reference-point'] = 'Ponto de referencia';
$language['postal-code'] = 'Codigo postal';
$language['finalize-and-pay'] = 'Finalizar e pagar';
$language['cart'] = 'Carrinho';
$language['delivery-address'] = 'Endereço para entrega';
...
$language['payment-via-mpesa'] = 'Pagamento via mpesa';
...
// Requests
$language['requests'] = 'Solicitações';
$language['manage-requests'] = 'Gerir solicitações';
$language['respond-request'] = 'Responder solicitação';
$language['total-requests'] = 'Total de solicitações';
$language['responded-today'] = 'Respondidas hoje';
$language['requested-today'] = 'Solicitadas hoje';
