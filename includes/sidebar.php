	...
	<div class="border-right" id="sidebar-wrapper">
		<div class="list-group list-group-flush">
			...
			<?php if(isset($_SESSION['userId']) && $_SESSION['userId']!=3) { ?>
				...
				<a id="navCategories" href="categoria.php?c=manctg" class="list-group-item list-group-item-action border-0"><i class="fas fa-clipboard fa-lg mr-2"></i>Categorias</a>
